...
header="run_id,timestamp,encoder,embedding_dim,encode_duration_s,cpu_avg_pct,cpu_max_pct,rss_before_mb,rss_peak_mb,embedding_bytes,rss_net_growth_mb,payload_bytes,metadata_bytes,estimated_request_mb,transfer_duration_s,network_packets,network_tx_bytes,network_total_bytes,network_total_mb,cloud_receive_duration_s,network_latency_s,inference_duration_s,inference_per_record_s,test_accuracy,test_f1_score"
...
cols = [
    ...
    "network_packets","network_tx_bytes","network_total_bytes","network_total_mb",
    "cloud_receive_duration_s","network_latency_s","inference_duration_s","inference_per_record_s",
